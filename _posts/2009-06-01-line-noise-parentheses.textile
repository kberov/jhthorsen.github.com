---
layout: post
title: Line noise 1: parentheses
---
...
.pre push(@text, sprintf('I got %i foos', int(shift(@{ $obj->get_foo() }))));

Versus:

.pre push @text, sprintf 'I got %i foos', int shift @{ $obj->get_foo };

I don't understand how the first one is less noise than the second (!). I also don't understand how you can maintain or read the first one.
