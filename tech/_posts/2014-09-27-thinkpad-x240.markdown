...
power cable. To fix this, you can blacklist wireless:
    ...
    curl -L http://thorsen.pm/attachments/power-d-thinkpad-x240-wireless.txt \
      | sudo tee /usr/lib/pm-utils/power.d/thinkpad-x240-wireless
    sudo chmod +x /usr/lib/pm-utils/power.d/thinkpad-x240-wireless
